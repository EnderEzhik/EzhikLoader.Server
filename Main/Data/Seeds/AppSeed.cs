    ...
    public static class AppSeed
    {
        public static void Seed(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<App>().HasData(
                ...
                new App() { Id = 3, Name = "testApp3", Description = "Description for testApp3", Version = "0.0.3", Price = 399, IsActive = true, FileName = "testApp3.txt" },
                new App() { Id = 4, Name = "Telegram Logger Interface", Description = "Logger for save all messages from telegram account", Version = "1.0.0", Price = 259, IsActive = true, FileName = "interface.exe" }
            );
        }
    }
}
